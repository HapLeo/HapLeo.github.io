...
服务导出指服务提供者Provider开启网络服务并将URL注册到注册中心的过程。这个过程大致分为三个部分：**组装URL**、**生成invoker**、**开启与注册服务**。
...
**开启与注册服务：**Dubbo通过读取URL中的协议信息，开启相应的服务，默认使用dubbo协议，启动netty开启网络服务用于接收网络请求，Dubbo支持多协议的服务导出。在开启服务后，向注册中心注册服务地址，Dubbo默认使用zookeeper作为注册中心，且支持多注册中心的服务注册。
